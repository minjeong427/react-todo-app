...
const Join = () => {
  ...
  const nameHandler = debounce((inputValue) => {
    ...
    dispatch({ type: 'SET_USER_VALUE', key: 'userName', value: inputValue });
    dispatch({ type: 'SET_MESSAGE', key: 'userName', value: msg });
    dispatch({ type: 'SET_CORRECT', key: 'userName', value: flag });
  }, 500);
  ...
  const passwordHandler = debounce((inputValue) => {
    ...
    dispatch({ type: 'SET_MESSAGE', key: 'passwordCheck', value: '' });
